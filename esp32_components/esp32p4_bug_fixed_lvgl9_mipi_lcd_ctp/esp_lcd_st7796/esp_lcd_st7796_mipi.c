...
static const st7796_lcd_init_cmd_t vendor_specific_init_default[] = {
    ...
    {0x11, (uint8_t[]){0xe0, 0xf0, 0x09, 0x0b, 0x06, 0x04, 0x15, 0x2f, 0x54, 0x42, 0x3c, 0x17, 0x14, 0x18, 0x1b}, 15, 0},
    {0x11, (uint8_t[]){0xe1, 0xf0, 0x09, 0x0b, 0x06, 0x04, 0x03, 0x2d, 0x43, 0x42, 0x3b, 0x16, 0x14, 0x17, 0x1b}, 15, 0},
    {0x11, (uint8_t[]){0xe0, 0xf0, 0x09, 0x0b, 0x06, 0x04, 0x15, 0x2f, 0x54, 0x42, 0x3c, 0x17, 0x14, 0x18, 0x1b}, 15, 0},
    {0x11, (uint8_t[]){0xe1, 0xf0, 0x09, 0x0b, 0x06, 0x04, 0x03, 0x2d, 0x43, 0x42, 0x3b, 0x16, 0x14, 0x17, 0x1b}, 15, 0},
...
static esp_err_t panel_st7796_init(esp_lcd_panel_t *panel)
{
    ...
    for (int i = 0; i < init_cmds_size; i++) {
        // Send command
        //ESP_LOGI(TAG,"c:%x\t\tlen = %d",init_cmds[i].cmd, init_cmds[i].data_bytes);
